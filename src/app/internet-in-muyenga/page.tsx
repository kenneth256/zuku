        ...
        <section className="section" style={{ paddingTop: '8rem', paddingBottom: '5rem' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            ...
            <p className="section-sub animate-up d3" style={{ margin: '0 auto 2.5rem' }}>
              Muyenga residents enjoy some of Kampala&apos;s best lake views — and now the best internet too.
              Whether you&apos;re on Tank Hill Road or near Muyenga Butchery, Zuku Fiber delivers unlimited broadband with zero data caps.
            </p>
