        ...
        <section className="section" style={{ paddingTop: '8rem', paddingBottom: '5rem' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            ...
            <p className="section-sub animate-up d3" style={{ margin: '0 auto 2.5rem' }}>
              Upgrade your home life with the fastest internet in Ntinda. Whether you are in Ministers&apos; Village or near Ntinda Shopping Centre, Zuku Fiber brings you world-class connectivity without data caps.
            </p>
